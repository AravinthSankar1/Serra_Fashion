...
const REFUND_REASONS = [
    ...
    "Product is damaged, but shipping box OK",
...
export default function RefundModal({ isOpen, onClose, onConfirm, isLoading }: RefundModalProps) {
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="p-5 md:p-8 border-b border-gray-50 flex items-center justify-between shrink-0 bg-white">
                        <div>
                            <h3 className="text-xl font-serif font-bold text-gray-900">Request Refund / Return</h3>
                            <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest mt-1">Please tell us why you're returning this item</p>
                        </div>
                    ...
                    <div className="p-5 md:p-8 space-y-6 overflow-y-auto custom-scrollbar">
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Reason for Refund Request</label>
                        ...
                        <div className="bg-amber-50/50 border border-amber-100 rounded-2xl p-4 flex items-start gap-3">
                            ...
                            <p className="text-[11px] text-amber-800 leading-relaxed font-medium">
                                <strong>Note:</strong> Once requested, our team will review your request. If approved, your refund will be processed to the original payment method. For returns, you'll receive instructions on how to ship the item back.
                            </p>
                        </div>
                    </div>
